...
- [ ] 1. Update Exercise data model to include equipment
  - [ ] 1.1 Update make-exercise function to accept equipment parameter
  ...
  - [ ] 1.3 Update default exercises to include equipment
    - Add equipment field to all 10 default exercises
    - Most exercises: ["None"], Wall Sit: ["A wall"]
    - _Requirements: 6.1, 6.6_
  
  - [ ] 1.4 Update LocalStorage schema to include equipment
...
- [ ] 3. Implement alphabetical sorting for exercise library
  - [ ] 3.1 Add sort-by-name function to library namespace
...
- [ ] 4. Implement equipment filtering system
  ...
  - [ ] 4.4 Update session configuration state to include equipment selection
  ...
  - [ ] 4.6 Update generate-session to filter by equipment
...
- [ ] 5. Implement time constraints (20s min, 2min max)
  - [ ] 5.1 Add apply-time-constraints function to session namespace
  ...
  - [ ] 5.4 Add split-long-exercises function to session namespace
  ...
  - [ ] 5.6 Integrate time constraints into generate-session
...
- [ ] 6. Implement progressive difficulty arrangement
  - [ ] 6.1 Add sort-by-difficulty function to session namespace
    - Sort exercises by difficulty value (ascending)
    - Return sorted exercise list
    - _Requirements: 2.9_
  
  - [ ] 6.2 Add arrange-progressive-difficulty function to session namespace
  ...
  - [ ] 6.4 Integrate progressive arrangement into generate-session
    - Apply arrangement as final step before returning session plan
    - _Requirements: 2.9_

- [ ] 7. Checkpoint - Ensure session generation tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 8. Implement session progress tracking
  - [ ] 8.1 Add total-elapsed-seconds to timer state
    - Track total elapsed time across all exercises
    - Increment on each timer tick
    - Reset on session restart
    - _Requirements: 9.3_
  
  - [ ] 8.2 Add calculate-progress-percentage function to timer namespace
  ...
  - [ ] 8.4 Update timer tick logic to track elapsed time
...
- [ ] 9. Implement skip exercise functionality
  - [ ] 9.1 Add skip-exercise! function to timer namespace
  ...
  - [ ] 9.3 Add time reallocation logic
...
- [ ] 10. Implement web search functionality
  - [ ] 10.1 Add search-exercise function to timer namespace
  ...
  - [ ] 10.3 Add search button to control panel
...
- [ ] 11. Implement dynamic difficulty adjustment
  - [ ] 11.1 Add update-exercise-difficulty! function to library namespace
  ...
  - [ ] 11.4 Add difficulty adjustment controls to exercise display
    - Add increase/decrease buttons
    - Show current difficulty value
    - Only visible during active exercise
    - _Requirements: 14.1_
  
  - [ ] 11.5 Wire difficulty controls to update function
...
- [ ] 12. Checkpoint - Ensure timer and control tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 13. Update UI components for new features
  - [ ] 13.1 Add equipment checkboxes to configuration panel
  ...
  - [ ] 13.3 Update add-exercise-dialog to include equipment field
    - Add multi-select or text input for equipment
    - Allow multiple equipment types per exercise
    - Default to ["None"]
    - _Requirements: 7.4_
  
  - [ ] 13.4 Create progress-bar component
  ...
  - [ ] 13.5 Add skip button to control panel
    - Show when session is running
    - Wire to skip-exercise! function
    - _Requirements: 5.6_
  
  - [ ] 13.6 Update control panel with search button
    - Show when session is paused
    - Wire to search-exercise function
    - _Requirements: 5.8, 5.9_
  
  - [ ] 13.7 Add difficulty adjustment controls to exercise display
...
- [ ] 14. Update React 18 compatibility
  - [ ] 14.1 Replace ReactDOM.render with createRoot
...
- [ ] 15. Update import/export to include equipment
  - [ ] 15.1 Update export-to-json to include equipment field
    - Ensure equipment is serialized in JSON
    - _Requirements: 10.4_
  
  - [ ] 15.2 Update import-from-json to handle equipment field
    - Parse equipment from imported JSON
    - Validate equipment is a vector
    - Handle missing equipment (default to ["None"])
    - _Requirements: 11.4_
  
  - [ ] 15.3 Update conflict detection to consider equipment
...
- [ ] 16. Integration and final wiring
  - [ ] 16.1 Wire equipment selection to session generation
